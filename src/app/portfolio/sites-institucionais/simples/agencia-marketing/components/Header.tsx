...
export default function Header() {
    ...
    const navLinks = [
        { href: "/portfolio/sites-institucionais/simples/agencia-marketing", label: "Home" },
        { href: "/portfolio/sites-institucionais/simples/agencia-marketing/sobre", label: "Sobre" },
        { href: "/portfolio/sites-institucionais/simples/agencia-marketing/servicos", label: "Serviços" },
        { href: "/portfolio/sites-institucionais/simples/agencia-marketing/portfolio", label: "Portfólio" },
        { href: "/portfolio/sites-institucionais/simples/agencia-marketing/contato", label: "Contato" }
    ];
        ...
        <header className="bg-gradient-to-r from-purple-900 via-purple-800 to-pink-800 text-white sticky top-0 z-50 shadow-lg">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-20">
                    <Link href="/portfolio/sites-institucionais/simples/agencia-marketing" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
