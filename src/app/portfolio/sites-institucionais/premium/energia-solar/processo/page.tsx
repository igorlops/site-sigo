        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <section className="bg-amber-500 py-16">
                <div className="container mx-auto px-6 md:px-10 lg:px-20 text-center">
                    ...
                    <Link href="/portfolio/sites-institucionais/premium/energia-solar/contato" className="inline-flex items-center gap-2 bg-sky-950 text-white px-8 py-4 rounded-xl font-bold hover:bg-sky-900 transition-colors shadow-lg">
