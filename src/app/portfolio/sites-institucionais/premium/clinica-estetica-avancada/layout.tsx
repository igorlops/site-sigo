...
export default function Layout({
    ...
    return (
        <div className={`${playfair.variable} ${inter.variable} font-sans antialiased text-neutral-800 bg-neutral-50 selection:bg-rose-100 selection:text-rose-900 scroll-smooth`}>
            <Header />
