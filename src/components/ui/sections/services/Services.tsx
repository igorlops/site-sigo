...
export default function Services() {
    ...
    return (
        <>
            <div id="services" className="bg-gray-900 py-5 w-fullrelative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                    ...
                    <div className="relative mx-auto gap-x-8 lg:mx-0 grid grid-cols-1 lg:grid-cols-2 gap-4 grid-flow-row">
                        ...
                        <div className="flex justify-center flex-col">
                            ...
                            <div className="text-center my-9">
                                ...
                                <p className="text-white text-md lg:text-lg text-left w-full mt-9 leading-6">
